...
RoBinaryImage::RoBinaryImage() : RoMonoImage()
{
}

RoBinaryImage::~RoBinaryImage()
{
}
 ...
 */
int RoBinaryImage::GetNumberParticles()
{
	int numParticles = 0;
 ...
 */
ParticleAnalysisReport RoBinaryImage::GetParticleAnalysisReport(int particleNumber)
{
 ...
 */
vector<ParticleAnalysisReport>* RoBinaryImage::GetOrderedParticleAnalysisReports()
{
 ...
 */
void RoBinaryImage::Write(const char *fileName)
{
 ...
 */
double RoBinaryImage::ParticleMeasurement(int particleNumber, MeasurementType whatToMeasure)
{
	double returnDouble;
	int success;
...
//Normalizes to [-1,1]
double RoBinaryImage::NormalizeFromRange(double position, int range)
{
 ...
 */
bool RoBinaryImage::CompareParticleSizes(ParticleAnalysisReport particle1, ParticleAnalysisReport particle2)
{
